        ...
        try {
            ...
            for ($i = 0; $i < $monthsAhead; $i++) {
                ...
                try {
                    ...
                    // Patterns to exclude from events listing
                    $excludedPatterns = ['OPEN GYM', 'CLOSED'];
                    ...
                    foreach ($calendarData['calendar']['weeks'] as $week) {
                        foreach ($week['days'] as $day) {
                            ...
                            foreach ($day['events'] as $event) {
                                ...
                                // Skip non-event items (regular programs, closures)
                                $skip = false;
                                ...
                                if (strpos($title, 'CAMP') !== false) {
                                    $type = 'camp';
                                } elseif (strpos($title, 'CLINIC') !== false) {
                                    $type = 'clinic';
                                } else {
                                    $type = 'event';
                                }
            ...
            ], 'Events and clinics retrieved successfully');
