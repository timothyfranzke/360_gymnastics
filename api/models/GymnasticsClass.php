...
class GymnasticsClass {
    ...
    public function create($data) {
        $query = "INSERT INTO {$this->table}
                  (id, name, age_range, description, skills, structure, prerequisites, ratio, duration, url, featured, category, jackrabbit_id, created_at, updated_at)
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
    ...
    private function formatResult($result) {
        ...
        // Convert jackrabbit_id to camelCase
        if (isset($result['jackrabbit_id'])) {
            $result['jackrabbitId'] = $result['jackrabbit_id'];
            unset($result['jackrabbit_id']);
        }
