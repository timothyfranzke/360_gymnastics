  ...
  return (
    <section className="py-16 px-6 bg-white">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12" style={{ color: '#0119b3' }}>Our Gallery</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="relative overflow-hidden rounded-lg shadow-md group">
            ...
            <div className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-30 transition duration-300 flex items-center justify-center" style={{ backgroundColor: 'rgba(1, 25, 179, 0)' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'rgba(1, 25, 179, 0.3)'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'rgba(1, 25, 179, 0)'}>
        ...
        <div className="text-center">
          <a href="/gallery" className="inline-block text-white font-bold py-3 px-8 rounded-lg shadow transition" style={{ backgroundColor: '#0226ff' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#0119b3'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#0226ff'}>
            View Gallery
          </a>
        </div>
      </div>
