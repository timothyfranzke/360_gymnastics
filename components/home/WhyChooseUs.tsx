  ...
  return (
    <section className="py-12 px-6 bg-gray-50">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12" style={{ color: '#0119b3' }}>Why Choose Us</h2>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md transition hover:shadow-lg">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4" style={{ backgroundColor: '#fc7900' }}>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md transition hover:shadow-lg">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mb-4" style={{ backgroundColor: '#0226ff' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative">
            ...
            />
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 rounded-full opacity-20" style={{ backgroundColor: '#fc7900' }}></div>
            <div className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full opacity-20" style={{ backgroundColor: '#0226ff' }}></div>
          </div>
        </div>
      </div>
    </section>
