...
export class ClassesService {
  ...
  private transformToApiFormat(data: any): any {
    ...
    // Transform jackrabbitId to jackrabbit_id
    if (transformed.jackrabbitId !== undefined) {
      transformed.jackrabbit_id = transformed.jackrabbitId;
      delete transformed.jackrabbitId;
    }
